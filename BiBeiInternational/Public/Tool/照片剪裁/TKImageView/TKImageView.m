...
//        _btnOK.frame = CGRectMake(_btnCancel.origin.x-_btnCropWH-_margin, _btnCancel.origin.y, _btnCropWH, _btnCropWH);
...
- (void)createCropButton {
    ...
    [_btnOK setBackgroundImage:[UIImage imageNamed:@"CorppingOK"] forState:UIControlStateNormal];
    ...
    [_btnCancel setBackgroundImage:[UIImage imageNamed:@"CorppingDeny"] forState:UIControlStateNormal];
