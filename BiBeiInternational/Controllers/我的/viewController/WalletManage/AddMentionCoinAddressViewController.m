...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = LocalizationKey(@"mentionMoneyAddress");
    ...
    LYEmptyView *emptyView = [LYEmptyView emptyViewWithImageStr:@"emptyData" titleStr:LocalizationKey(@"noAddAddressTip") detailStr:nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([addressInfo.remark isEqualToString:@""] || addressInfo.remark == nil) {
        cell.remark.text = LocalizationKey(@"addAddressNoRemark");
    }else{
