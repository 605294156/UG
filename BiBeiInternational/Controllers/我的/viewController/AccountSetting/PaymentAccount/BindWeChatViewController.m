...
-(void)changeHeaderImage{
    ...
    UIAlertController *sheet =[UIAlertController alertControllerWithTitle:LocalizationKey(@"projectNameTip")  message:LocalizationKey(@"inputWeChatAddImage") preferredStyle:UIAlertControllerStyleActionSheet];
...
- (IBAction)saveBtnClick:(id)sender {
    if ([self.weChatNum.text isEqualToString:@""]) {
        [self.view ug_showToastWithToast:LocalizationKey(@"inputWeChatNum") ];
        return;
    }
