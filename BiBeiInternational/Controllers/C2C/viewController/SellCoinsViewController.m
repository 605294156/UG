...
//MARK:--国际化通知处理事件
- (void)languageChange{
    LYEmptyView *emptyView=[LYEmptyView emptyViewWithImageStr:@"emptyData" titleStr:LocalizationKey(@"noSellCoinTip") detailStr:nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.buyButton setTitle:LocalizationKey(@"sell") forState:UIControlStateNormal];
