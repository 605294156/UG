...
//  BiBeiInternational
//
//  Created by XiaoCheng on 09/12/2019.
//  Copyright © 2019 XinHuoKeJi. All rights reserved.
//

#import "UGMySwitch.h"

@implementation UGMySwitch

- (void)setBlock:(MyBlock)block{
    CGFloat gap = 2.f;
    CGRect frame = CGRectMake(self.mj_x, self.mj_y, self.mj_w, self.mj_h);
...
//    _OnStatus=YES;
    ...
    UIImageViewBack.backgroundColor=HEXCOLOR(0x6185d3);
...
- (instancetype)initWithFrame:(CGRect)frame withGap:(CGFloat)gap{
...
- (instancetype)initWithFrame:(CGRect)frame withGap:(CGFloat)gap statusChange:(MyBlock)block{
    self = [super initWithFrame:frame];
...
//            UIImageViewBlock.backgroundColor=[UIColor whiteColor];
            UIImageViewBack.backgroundColor = HEXCOLOR(0xd7d7d7);
        }
