...
- (void)viewDidLoad {
    ...
    self.moreView.backgroundColor=[[UIColor blackColor] colorWithAlphaComponent:0.8];
            ...
            if ([resPonseObj isKindOfClass:[NSArray class]]) {
                ...
                for (int i=0; i<symbolArray.count; i++) {
                    ...
                    if ([model.symbol isEqualToString:symbol]) {
                        ...
                        self.PriceLabel.text=[NSString stringWithFormat:@"%@",model.closeStr];
                        ...
                        self.highLabel.text=[NSString stringWithFormat:@"%@:%@",LocalizationKey(@"highest"),[ToolUtil stringFromNumber:model.high withlimit:length]];
                        self.lowLabel.text=[NSString stringWithFormat:@"%@:%@",LocalizationKey(@"minimumest"),[ToolUtil stringFromNumber:model.low withlimit:length]];
                        self.amountLabel.text=[NSString stringWithFormat:@"%@:%.4f",LocalizationKey(@"24H"),model.volume];
                        if (model.change <0) {
