...
- (void)awakeFromNib {
    ...
    self.indView.backgroundColor=[[UIColor blackColor] colorWithAlphaComponent:0.8];
  ...
  //  self.subCurrentBtn=self.macdBtn;
   ...
   // [self.macdBtn setTitleColor:[UIColor ma30Color] forState:UIControlStateNormal];
    ...
    self.lineView.backgroundColor=[[UIColor blackColor] colorWithAlphaComponent:0.8];
...
- (IBAction)btnClick:(UIButton *)sender {
    ...
    switch (sender.tag) {
        ...
        case 10086:
        {
            ...
            self.indView.hidden=YES;
            self.moreBtn.backgroundColor=[[UIColor blackColor] colorWithAlphaComponent:0.8];
            self.indexBtn.backgroundColor=[UIColor clearColor];
        ...
        case 10087:
        {
            ...
            self.moreView.hidden=YES;
            self.moreBtn.backgroundColor=[UIColor clearColor];
            self.indexBtn.backgroundColor=[[UIColor blackColor] colorWithAlphaComponent:0.8];
            return;
        }
            break;
        default:
