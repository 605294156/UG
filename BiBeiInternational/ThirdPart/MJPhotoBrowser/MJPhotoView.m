...
- (void)photoStartLoad
{
    if (_photo.image) {
        ...
        ESWeak_(_imageView);
        [[SDWebImageManager sharedManager] loadImageWithURL:_photo.url options:SDWebImageRetryFailed progress:^(NSInteger receivedSize, NSInteger expectedSize, NSURL * _Nullable targetURL) {
